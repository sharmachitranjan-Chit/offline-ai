...
export const MODEL_CATALOG: ModelEntry[] = [
  ...
  },
  {
    ...
    license: 'Gemma License',
    description:
      'A genuinely small model that still writes coherently and follows instructions — the one to reach for when RAM is tight rather than settling for something that barely answers.',
    repo: 'ggml-org/gemma-3-1b-it-GGUF',
    filename: 'gemma-3-1b-it-Q4_K_M.gguf',
    recommendedContext: 4096,
    tags: ['tiny', 'multilingual', 'recommended'],
  },
  {
    ...
    license: 'Apache 2.0',
    description:
      'The middle ground between the 0.5B and 3B Qwen models — noticeably more capable than the smallest option without needing much more memory.',
  ...
  },
  {
    ...
    license: 'Apache 2.0',
    description:
      'About as small as a genuinely usable chat model gets. Fits comfortably even when almost nothing else does — good for a phone that is very short on free memory right now.',
